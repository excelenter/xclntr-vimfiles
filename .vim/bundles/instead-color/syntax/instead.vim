...
syn keyword luaFunc nam dsc act tak use used enter entered exit left
syn keyword luaFunc inv disp life obj way pic var 
syn keyword luaFunc room obj iroom xroom dlg stat menu iobj player game
